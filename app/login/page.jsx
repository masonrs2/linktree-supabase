    ...
    <div className="w-screen flex">
        <div className="justify-center w-full h-screen items-center flex">
            <div className="bg-white/25 px-12 rounded-md">
                <h1 className="mt-10 justify-center w-full pl-32 text-2xl text-white font-light  ">Login</h1>
                ...
                <form >
                    ...
                    <p className="mt-3 mb-16 w-full justify-center text-gray-400 items-center flex">Don't have an account?<Link href="/login"><span className="underline underline-offset-4 decoration-gray-200 ml-1 text-black">Register here.</span></Link> </p>
                </form>
            </div>
        </div>
    </div>
